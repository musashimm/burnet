...
# Make symbolic link ln -s *BURNET_DIR*/Propox/MMNet1002/configs/buildroot.config *BUILDROOT_DIR*/configs/MMNet1002_defconfig
# Change directory to *BUILDROOT_DIR*
# Type _make_ MMNet1002_defconfig (to configure)
